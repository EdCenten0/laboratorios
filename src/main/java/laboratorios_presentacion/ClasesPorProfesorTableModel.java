    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
       ...
       switch(columnIndex){
           ...
           case 2: 
               ...
               while(this.profesores.get(j).getId() != preguntado.getId_profesor() || this.profesores.get(j).getId() == preguntado.getId_profesor()){
                    if(this.profesores.get(j).getId() == preguntado.getId_profesor()){
                    preguntadoProfesores.setNombre_profesor(this.profesores.get(j).getNombre_profesor());
                    preguntadoProfesores.setApellido_profesor(this.profesores.get(j).getApellido_profesor());
                    preguntadoProfesores.setCodigo_profesor(this.profesores.get(j).getCodigo_profesor());
                    break;
                }else{
                    j++;
                }
               ...
               return preguntadoProfesores.getNombre_profesor().concat(" ").concat(preguntadoProfesores.getApellido_profesor().concat(" -- ").concat(preguntadoProfesores.getCodigo_profesor()));
