 ...
 * @author cchav
 */
public class Laboratorios_table extends javax.swing.JFrame {

    private DAOManager managerP;
    private LaboratoriosTableModel model;
    ...
    public void loadData(){
        if(this.laboratorio != null){
            nombre.setText(this.laboratorio.getNombre_laboratorio());
        }else{
            nombre.setText("");
        }
    ...
    public void saveData(){
        ...
        this.laboratorio.setNombre_laboratorio(this.nombre.getText());
    }
    
    public Laboratorios geLaboratorioSeleccionado() throws DAO_exception{
        Long id = (Long) table.getValueAt(table.getSelectedRow(), 0);
        return managerP.getLaboratorios_interface().obtener(id);
    }
    
    
    
    
    public Laboratorios_table(DAOManager manager) throws DAO_exception {
        initComponents();
        this.setLocationRelativeTo(null);
        this.managerP = manager;
        this.model = new LaboratoriosTableModel((managerP.getLaboratorios_interface()));
    ...
    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
        try {
            ...
            Laboratorios laboratorio = geLaboratorioSeleccionado();
    ...
    private void borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrarActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(rootPane, "Seguro que quieres borrar las clase?","Borrar Clase", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION){
            try {
                Laboratorios laboratorio = geLaboratorioSeleccionado();
                managerP.getLaboratorios_interface().eliminar(laboratorio);
                model.updateModel();
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        saveData();
        Laboratorios laboratorio = getLaboratorio();

        if(laboratorio.getId() == null){
            try {
                managerP.getLaboratorios_interface().insertar(laboratorio);
            } catch (DAO_exception ex) {
                Logger.getLogger(Clases_table.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
            try {
                managerP.getLaboratorios_interface().modificar(laboratorio);
            } catch (DAO_exception ex) {
                Logger.getLogger(Clases_table.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
